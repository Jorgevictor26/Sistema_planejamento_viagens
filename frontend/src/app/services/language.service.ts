...
const dictionary = {
  pt: {
    ...
    heroTitle: 'Planeie a sua próxima viagem com clareza.',
    heroText: 'Escolha o destino, veja clima e mapa, organize roteiro, despesas e favoritos num só painel de viagem.',
    ...
    popularTitle: 'Sugestões para começar o plano',
    popularEyebrow: 'Recomendações',
    popularText: 'Alguns destinos rápidos para testar o planejamento, comparar contexto e transformar a ideia numa viagem.',
    ...
    howWorksLabel: 'Como funciona',
    howWorksEyebrow: 'Como funciona',
    howWorksTitle: 'Da ideia ao roteiro em poucos passos.',
    howWorksText: 'Escolha o destino, veja contexto real e transforme a inspiração numa viagem organizada sem perder tempo.',
    howWorksSearchTitle: 'Pesquise destinos reais',
    howWorksSearchText: 'Use a busca para encontrar cidades com coordenadas, clima e mapa prontos para explorar.',
    howWorksCompareTitle: 'Compare lugares e experiências',
    howWorksCompareText: 'Veja praias, serra, deserto, restaurantes, atrações e orçamento antes de decidir o caminho.',
    howWorksPlanTitle: 'Crie a viagem completa',
    howWorksPlanText: 'Guarde o destino, monte roteiros, acompanhe despesas e salve favoritos para consultar depois.',
  ...
  en: {
    ...
    navAbout: 'About',
    heroEyebrow: 'Travel Planner System',
    heroTitle: 'Plan your next trip with clarity.',
    heroText: 'Choose the destination, check weather and map, organize itinerary, expenses and favorites in one trip workspace.',
    heroStart: 'Start now',
    ...
    popularTitle: 'Suggestions to start planning',
    popularEyebrow: 'Recommendations',
    popularText: 'A few quick destinations to test planning, compare context and turn the idea into a trip.',
    ...
    howWorksTitle: 'From idea to itinerary in a few steps.',
    howWorksText: 'Choose the destination, review real context and turn inspiration into an organized trip without wasting time.',
    howWorksSearchTitle: 'Search real destinations',
    howWorksSearchText: 'Use search to find cities with coordinates, weather and map ready to explore.',
    howWorksCompareTitle: 'Compare places and experiences',
    howWorksCompareText: 'See beaches, mountains, desert, restaurants, attractions and budget before choosing the route.',
    howWorksPlanTitle: 'Create the complete trip',
    howWorksPlanText: 'Save the destination, build itineraries, track expenses and keep favorites for later.',
...
const staticTranslations: Record<string, string> = {
  ...
  'Hotéis sugeridos': 'Suggested hotels',
  'Escolha um hotel para adicionar ao roteiro.': 'Choose a hotel to add to the itinerary.',
  'Mostramos poucas sugestões para manter a decisão simples. O botão abre um modal com dia, horário e descrição.': 'We show only a few suggestions to keep the decision simple. The button opens a modal with day, time and description.',
  'Roteiro desta viagem': 'This trip itinerary',
  'Atividades já adicionadas ao planejamento.': 'Activities already added to the plan.',
  'Os hotéis e locais adicionados aparecem aqui com dia, horário e descrição.': 'Added hotels and places appear here with day, time and description.',
  'Nenhuma atividade no roteiro desta viagem ainda.': 'No activity in this trip itinerary yet.',
  'Nenhum hotel retornado pela API para este destino ainda.': 'No hotel returned by the API for this destination yet.',
  '1 hotel selecionado': '1 hotel selected',
  'Selecionado para o roteiro': 'Selected for itinerary',
  'Adicionado durante a criação da viagem': 'Added while creating the trip',
  ...
  'Adicionar ao roteiro': 'Add to itinerary',
  'Local adicionado ao roteiro.': 'Place added to itinerary.',
  'Nao foi possivel adicionar ao roteiro.': 'Could not add to itinerary.',
  'Visitar local': 'Visit place',
  'Nota opcional': 'Optional note',
  'Ex: reservar mesa ou visitar ao pôr do sol': 'Ex: reserve a table or visit at sunset',
  'Adicionando...': 'Adding...',
